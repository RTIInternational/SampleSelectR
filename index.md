...
data. The primary functions in workflows are
[`allocate()`](https://rtiinternational.github.io/SampleSelectR/reference/allocate.md)
to allocate sample sizes though you can get a sample allocation in
another manner, if you prefer and
[`select_sample()`](https://rtiinternational.github.io/SampleSelectR/reference/select_sample.md)
where you specify your frame, sample sizes, sampling method, strata (if
relevant), measure of size (if relevant), and sort method (if relevant).
